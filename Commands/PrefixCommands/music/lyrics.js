...
module.exports = {
    ...
    run: async(client, message, args) => {
        const response = await lyrics(client, message, args);
        message.reply(response);
    }
}
async function lyrics(client, message, args) {
    ...
    try{
        const searches = await client.genius.songs.search(player.queue.current.title);
